    ...
    private ArrayList<Integer> ImportViwiki2Solr(ArrayList<ViwikiPageDTO> listpage, String solrServer) throws MalformedURLException, SolrServerException, IOException {
        ...
        try {
            while (iter.hasNext()) {
                ...
                doc.addField("wk_title_syn", pagedto.getTitle());
                doc.addField("wk_title_unsigned", RemoveSignVN(pagedto.getTitle()));
                doc.addField("wk_title_syn_unsigned", RemoveSignVN(pagedto.getTitle()));
                ...
                String text = pagedto.getText().replaceAll("\\<.*?\\>", "");
                doc.addField("wk_text", text);
                doc.addField("wk_text_syn", text);
                String text_unsigned = RemoveSignVN(text);
                doc.addField("wk_text_unsigned", text_unsigned);
                doc.addField("wk_text_syn_unsigned", text_unsigned);
